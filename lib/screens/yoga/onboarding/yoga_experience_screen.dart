...
import 'yoga_activity_screen.dart';
import 'yoga_plan_generation_screen.dart';

/// Yoga Onboarding Step 4 – "How long can you hold a plank?"
class YogaExperienceScreen extends StatefulWidget {
  const YogaExperienceScreen({super.key});

  @override
  State<YogaExperienceScreen> createState() => _YogaExperienceScreenState();
}
...
class _YogaExperienceScreenState extends State<YogaExperienceScreen> {
  ...
  static const _options = [
    {'title': 'Beginner', 'subtitle': 'Less than 15 seconds'},
    {'title': 'Intermediate', 'subtitle': '15–45 seconds'},
    {'title': 'Advanced', 'subtitle': '45+ seconds'},
  ];
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'This helps us assess your current fitness level.',
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: _selected != null
                          ? () {
                              YogaUserData().experienceLevel = _selected!;
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (_) => const YogaActivityScreen()));
                            }
                          : null,
                      child: Container(
                        height: 56,
