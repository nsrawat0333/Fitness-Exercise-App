...
/// Yoga Onboarding Step 7 – "Let us know you better" (Height + Weight)
class YogaBodyInfoScreen extends StatefulWidget {
  const YogaBodyInfoScreen({super.key});

  @override
  State<YogaBodyInfoScreen> createState() => _YogaBodyInfoScreenState();
}

class _YogaBodyInfoScreenState extends State<YogaBodyInfoScreen> {
          ...
          children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: const BoxDecoration(
                                      border: Border(
                                        top: BorderSide(color: Color(0xFFE0DCD4), width: 1),
                                        bottom: BorderSide(color: Color(0xFFE0DCD4), width: 1),
                                      ),
                                    ),
                                  ),
                                  Positioned(
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  YogaUserData().heightCm = _heightCm.toDouble();
                  YogaUserData().weightKg = _weightKg;
                  YogaUserData().isHeightCm = _heightIsCm;
                  YogaUserData().isWeightKg = _weightIsKg;

                  Navigator.push(context,
                      MaterialPageRoute(builder: (_) => YogaPlanGenerationScreen(
    ...
    for (int i = 0; i < totalBars; i++) {
      ...
      if (i % 5 == 0) {
        ...
        final textPainter = TextPainter(
          text: TextSpan(
            text: '$labelVal',
            style: const TextStyle(fontSize: 10, color: Color(0xFF999691)),
          ),
