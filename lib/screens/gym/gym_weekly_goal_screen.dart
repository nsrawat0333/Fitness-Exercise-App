...
class GymWeeklyGoalScreen extends StatefulWidget {
  const GymWeeklyGoalScreen({super.key});

  @override
  State<GymWeeklyGoalScreen> createState() => _GymWeeklyGoalScreenState();
}

class _GymWeeklyGoalScreenState extends State<GymWeeklyGoalScreen> {
  int _selectedDays = 3;
  String _firstDay = 'SUNDAY';

  static const _dayMessages = {
    1: "A great start! Even one day a week builds the habit.",
    2: "Nice balance! Two days is perfect for beginners.",
    3: "Good choice! 3 days a week is ideal for steady progress.",
    4: "Strong commitment! 4 days builds real consistency.",
    5: "Impressive! 5 days shows serious dedication.",
    6: "Excellent choice! 6 days a week is a high-performance routine typical of our most successful members.",
    7: "Maximum effort! 7 days for ultimate transformation.",
  };
                              ...
                              child: RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: _dayMessages[_selectedDays]!.replaceFirst('Excellent choice! ', '').replaceFirst(RegExp(r'^[A-Za-z !]+'), ''),
                ...
                children: [
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        GymUserData().weeklyGoalDays = _selectedDays;
                        Navigator.push(context,
                          MaterialPageRoute(builder: (_) => const GymBodyInfoScreen()));
                      },
                      child: Container(
                        height: 56,
                        decoration: BoxDecoration(
