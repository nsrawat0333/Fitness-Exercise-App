  ...
  static const Map<String, List<HomeExercise>> _exercisesByFocus = {
    ...
    'chest': [
      HomeExercise(
        ...
        image: 'assets/images/jsonimg/push_ups.png', animation: 'assets/images/jsonanimation/push up.json',
      ),
      HomeExercise(
        name: 'Wide Push-Ups',
      ...
      HomeExercise(
        ...
        image: 'assets/images/jsonimg/diamond_push_ups.png', animation: 'assets/images/jsonanimation/Diamond Push Up.json',
      ),
      HomeExercise(
    ...
    'back': [
      ...
      HomeExercise(
        ...
        image: 'assets/images/jsonimg/back_extensions.png', animation: 'assets/images/jsonanimation/Back Extension.json',
      ),
      HomeExercise(
        name: 'Inverted Rows',
      ...
      HomeExercise(
        ...
        image: 'assets/images/jsonimg/pull_ups.png', animation: 'assets/images/jsonanimation/Pull ups.json',
      ),
      HomeExercise(
        name: 'Good Mornings',
    ...
    'shoulders': [
      ...
      HomeExercise(
        ...
        image: 'assets/images/jsonimg/arm_circles.png', animation: 'assets/images/jsonanimation/arm circle.json',
      ),
      HomeExercise(
        name: 'Lateral Raises',
    ...
    'biceps': [
      ...
      HomeExercise(
        ...
        duration: '30s', reps: '10-15', rest: '30s',
        image: 'assets/images/jsonimg/bicep_curls.png', animation: 'assets/images/jsonanimation/Bicep Curl.json',
      ),
      HomeExercise(
        name: 'Hammer Curls',
        ...
        duration: '30s', reps: '10-15', rest: '30s',
        image: 'assets/images/jsonimg/hammer_curls.png', animation: 'assets/images/jsonanimation/Hammer curl.json',
      ),
      HomeExercise(
        ...
        image: 'assets/images/jsonimg/concentration_curls.png', animation: 'assets/images/jsonanimation/Concentration Curls.json',
      ),
      HomeExercise(
    ...
    'triceps': [
      ...
      HomeExercise(
        ...
        duration: '30s', reps: '8-12', rest: '30s',
        image: 'assets/images/jsonimg/close_grip_push_ups.png', animation: 'assets/images/jsonanimation/close Grip Push Ups.json',
      ),
      HomeExercise(
      ...
      HomeExercise(
        ...
        duration: '30s', reps: '10-12', rest: '30s',
        image: 'assets/images/jsonimg/overhead_tricep_extension.png', animation: 'assets/images/jsonanimation/Overhead Tricep extension.json',
      ),
      HomeExercise(
    ...
    'abs': [
      ...
      HomeExercise(
        ...
        duration: '30s', reps: '12-15', rest: '30s',
        image: 'assets/images/jsonimg/leg_raises.png', animation: 'assets/images/jsonanimation/Leg Raises.json',
      ),
      HomeExercise(
        name: 'Russian Twists',
        ...
        duration: '30s', reps: '15-20 each side', rest: '25s',
        image: 'assets/images/jsonimg/russian_twists.png', animation: 'assets/images/jsonanimation/Russian Twist.json',
      ),
      HomeExercise(
        name: 'Flutter Kicks',
      ...
      HomeExercise(
        ...
        image: 'assets/images/jsonimg/v_ups.png', animation: 'assets/images/jsonanimation/V - up.json',
      ),
      HomeExercise(
        ...
        duration: '30s', reps: '20-30', rest: '25s',
        image: 'assets/images/jsonimg/mountain_climbers.png', animation: 'assets/images/jsonanimation/Mountain Climbers.json',
      ),
    ],
    ...
    'legs': [
      ...
      HomeExercise(
        ...
        image: 'assets/images/jsonimg/jump_squats.png', animation: 'assets/images/jsonanimation/sqautss.json',
      ),
      HomeExercise(
        name: 'Lunges',
        ...
        image: 'assets/images/jsonimg/lunges.png', animation: 'assets/images/jsonanimation/Dubmbbell Lunges.json',
      ),
      HomeExercise(
        name: 'Wall Sit',
      ...
      HomeExercise(
        ...
        duration: '30s', reps: '15-20', rest: '30s',
        image: 'assets/images/jsonimg/sumo_squats.png', animation: 'assets/images/jsonanimation/sqautss.json',
      ),
      HomeExercise(
        name: 'Side Lunges',
        ...
        image: 'assets/images/jsonimg/side_lunges.png', animation: 'assets/images/jsonanimation/Dubmbbell Lunges.json',
      ),
      HomeExercise(
        name: 'Step-Ups',
    ...
    'full_body': [
      ...
      HomeExercise(
        ...
        duration: '30s', reps: '20-30', rest: '25s',
        image: 'assets/images/jsonimg/high_knees.png', animation: 'assets/images/jsonanimation/high knees.json',
      ),
    ],
  };
}
